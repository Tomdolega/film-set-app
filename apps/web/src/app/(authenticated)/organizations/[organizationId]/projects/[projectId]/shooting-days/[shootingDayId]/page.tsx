...
import { ExportToCalendarForm } from "@/features/calendar/components/export-to-calendar-form";
...
export default async function ShootingDayDetailPage(props: ShootingDayDetailPageProps) {
  ...
  try {
    ...
    assertOrganizationRouteMatch(organizationId, shootingDay.organizationId, "shooting day");
    assertProjectRouteMatch(projectId, shootingDay.projectId, "shooting day");
    assertOrganizationRouteMatch(organizationId, callSheet.organizationId, "call sheet");
    assertProjectRouteMatch(projectId, callSheet.projectId, "call sheet");
      ...
      <div className="stack stack--large">
        <section className="panel">
          ...
          <div className="panel__header">
            <div>
              <h2>{shootingDay.title}</h2>
              <p>
                {project.name} | {organization.name} | {shootingDay.date} | {shootingDay.location}
              </p>
            </div>
        ...
        <div className="two-column">
          ...
          <div className="stack">
            <ExportToCalendarForm shootingDayId={shootingDayId} />
