...
import { getDocument, type DocumentsRepository } from "@film-set-app/domain-documents";
...
interface GetDocumentControllerParams {
  projectsRepository: ProjectsRepository;
  documentsRepository: DocumentsRepository;
}

export function createGetDocumentController(params: GetDocumentControllerParams) {
